...
class DataSeeder:
    ...
    def create_complete_scenario(self) -> dict:
        ...
        regular_wallets = self.create_multiple_wallets(regular_user, [
            {"name": "Main Checking", "type": "checking", "balance": Decimal("2500.00")},
            {"name": "Emergency Savings", "type": "savings", "balance": Decimal("10000.00")},
        ...
        admin_wallets = self.create_multiple_wallets(admin_user, [
            {"name": "Admin Account", "type": "checking", "balance": Decimal("5000.00")},
        ])
        ...
        credit_wallets = self.create_multiple_wallets(credit_user, [
            {"name": "Credit Card", "type": "credit", "balance": Decimal("-500.00")},
            {"name": "Debit Account", "type": "checking", "balance": Decimal("800.00")},
        ])
