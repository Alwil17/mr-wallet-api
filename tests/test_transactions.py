...
class TestTransactions:
    ...
    def test_create_transaction_credit_wallet_overdraft(self, client: TestClient, user_auth):
    ...
    def test_get_wallet_transactions(self, client: TestClient, user_auth):
        ...
        response = client.get(
            f"/transactions/wallet/{wallet1_id}",
            headers=user_auth["headers"]
        )
    ...
    def test_wallet_balance_update_after_transactions(self, client: TestClient, user_auth):
        ...
        wallet_response = client.post("/wallets/", json=wallet_data, headers=user_auth["headers"])
        wallet_id = wallet_response.json()["id"]
    ...
    def test_transaction_operations_unauthorized(self, client: TestClient):
        ...
        operations = [
            ...
            ("POST", "/transactions/", {"type": "income", "amount": 100, "category": "salary", "wallet_id": 1}),
