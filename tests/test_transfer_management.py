...
class TestTransferManagement:
    ...
    def test_create_transfer_success(self, client: TestClient, user_auth):
        ...
        source_response = client.post("/wallets/", json=source_wallet_data, headers=user_auth["headers"])
        target_response = client.post("/wallets/", json=target_wallet_data, headers=user_auth["headers"])
    ...
    def test_create_transfer_credit_wallet_overdraft(self, client: TestClient, user_auth):
    ...
    def test_get_transfers_with_filters(self, client: TestClient, user_auth):
        ...
        # Create wallets
        wallet1_data = {"name": "Filter Wallet 1", "type": "checking", "balance": 2000.00}
        wallet2_data = {"name": "Filter Wallet 2", "type": "savings", "balance": 1000.00}
        wallet3_data = {"name": "Filter Wallet 3", "type": "cash", "balance": 500.00}
        
        wallet1_response = client.post("/wallets/", json=wallet1_data, headers=user_auth["headers"])
        wallet2_response = client.post("/wallets/", json=wallet2_data, headers=user_auth["headers"])
        wallet3_response = client.post("/wallets/", json=wallet3_data, headers=user_auth["headers"])
        ...
        transfers = [
            {"amount": 100.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "Small transfer"},
            {"amount": 500.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet3_id, "description": "Large transfer"},
            {"amount": 250.00, "source_wallet_id": wallet2_id, "target_wallet_id": wallet3_id, "description": "Medium transfer"}
        ]
        ...
        assert response.status_code == 200
        data = response.json()
        wallet1_transfers = [t for t in data["transfers"] if t["source_wallet_id"] == wallet1_id]
        assert len(wallet1_transfers) >= 2
        
        # Filter by minimum amount
        response = client.get(
            "/transfers/",
            params={"min_amount": 200.00},
            headers=user_auth["headers"]
        )
    ...
    def test_get_transfer_by_id(self, client: TestClient, user_auth):
        ...
        wallet1_data = {"name": "ID Test Wallet 1", "type": "checking", "balance": 800.00}
        wallet2_data = {"name": "ID Test Wallet 2", "type": "savings", "balance": 200.00}
        ...
        create_response = client.post("/transfers/", json=transfer_data, headers=user_auth["headers"])
    ...
    def test_get_wallet_transfers(self, client: TestClient, user_auth):
        ...
        # Create wallets
        wallet1_data = {"name": "Wallet Transfer Test 1", "type": "checking", "balance": 1500.00}
        wallet2_data = {"name": "Wallet Transfer Test 2", "type": "savings", "balance": 1000.00}
        wallet3_data = {"name": "Wallet Transfer Test 3", "type": "cash", "balance": 500.00}
        ...
        transfers = [
            {"amount": 200.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "From wallet1 to wallet2"},
            {"amount": 100.00, "source_wallet_id": wallet2_id, "target_wallet_id": wallet1_id, "description": "From wallet2 to wallet1"},
            {"amount": 50.00, "source_wallet_id": wallet3_id, "target_wallet_id": wallet2_id, "description": "Not involving wallet1"}
        ]
        ...
        response = client.get(f"/transfers/wallet/{wallet1_id}", headers=user_auth["headers"])
        ...
        wallet1_transfers = [
            t for t in data 
            if t["source_wallet_id"] == wallet1_id or t["target_wallet_id"] == wallet1_id
        ]
        assert len(wallet1_transfers) >= 2
    ...
    def test_get_transfer_summary(self, client: TestClient, user_auth):
        ...
        # Create wallets
        wallet1_data = {"name": "Summary Wallet 1", "type": "checking", "balance": 2000.00}
        wallet2_data = {"name": "Summary Wallet 2", "type": "savings", "balance": 1000.00}
        ...
        transfers = [
            {"amount": 300.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "Transfer 1"},
            {"amount": 150.00, "source_wallet_id": wallet2_id, "target_wallet_id": wallet1_id, "description": "Transfer 2"},
            {"amount": 200.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "Transfer 3"}
        ]
    ...
    def test_get_wallet_transfer_summary(self, client: TestClient, user_auth):
        ...
        # Create wallets
        wallet1_data = {"name": "Wallet Summary Test 1", "type": "checking", "balance": 2000.00}
        wallet2_data = {"name": "Wallet Summary Test 2", "type": "savings", "balance": 1000.00}
        ...
        transfers = [
            {"amount": 400.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "Sent from wallet1"},
            {"amount": 100.00, "source_wallet_id": wallet2_id, "target_wallet_id": wallet1_id, "description": "Received by wallet1"},
            {"amount": 200.00, "source_wallet_id": wallet1_id, "target_wallet_id": wallet2_id, "description": "Sent from wallet1 again"}
        ]
        ...
        # Get wallet1 summary
        response = client.get(f"/transfers/wallet/{wallet1_id}/summary", headers=user_auth["headers"])
    ...
    def test_delete_transfer_success(self, client: TestClient, user_auth):
        ...
        # Create wallets with specific balances
        wallet1_data = {"name": "Delete Test Wallet 1", "type": "checking", "balance": 1000.00}
        wallet2_data = {"name": "Delete Test Wallet 2", "type": "savings", "balance": 500.00}
    ...
    def test_alternative_transfer_endpoint(self, client: TestClient, user_auth):
        ...
        # Create wallets
        wallet1_data = {"name": "Alt Endpoint Wallet 1", "type": "checking", "balance": 1200.00}
        wallet2_data = {"name": "Alt Endpoint Wallet 2", "type": "savings", "balance": 800.00}
    ...
    def test_transfer_operations_unauthorized(self, client: TestClient):
        ...
        operations = [
            ("GET", "/transfers/", None),
            ("POST", "/transfers/", {"amount": 100, "source_wallet_id": 1, "target_wallet_id": 2}),
